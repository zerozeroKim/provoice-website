...
export type TalentProfile = { name: string; avatarSrc: string; locale: string; tags: string[]; duration: number; gender?: string; tones?: string[]; favorites?: number; completedProjects?: number };
