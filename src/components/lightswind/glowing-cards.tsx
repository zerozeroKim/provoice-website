...
export const GlowingCard: React.FC<GlowingCardProps> = ({
  ...
  return (
    <div
      className={cn(
        "relative w-full min-w-0 p-6 rounded-2xl text-black dark:text-white",
...
export const GlowingCards: React.FC<GlowingCardsProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={cn("grid w-full gap-[var(--gap)]", responsive ? "grid-cols-1" : "grid-cols-1")}
          style={{
            gridTemplateColumns: responsive ? 'repeat(3, minmax(0, 1fr))' : '1fr',
          }}
        >
          {children}
        </div>
        ...
        {enableGlow && (
          ...
          >
            <div
              className={cn("grid w-full max-w-[var(--max-width)] gap-[var(--gap)] mx-auto", "grid-cols-1")}
              style={{
                padding: "var(--padding)",
                gridTemplateColumns: responsive ? 'repeat(3, minmax(0, 1fr))' : '1fr',
              }}
